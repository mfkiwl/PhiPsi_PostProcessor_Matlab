...
%##########################            User defined part        ############################################
%###########################################################################################################
% Filename='3D_Block_21x21x21_Sur_Fixed';Work_Dirctory='X:\PhiPsi_Work\3D_Block_21x21x21_Sur_Fixed';
% Filename='3D_Block_20x20x20_Fixed';Work_Dirctory='X:\PhiPsi_Work\3D_Block_20x20x20_Fixed';
% Filename='3d_hf_toughness_dominated';Work_Dirctory='X:\PhiPsi_Work\3d_hf_toughness_dominated';
% Filename='3d_simple_friction_crack_verify';Work_Dirctory='X:\PhiPsi_Work\3d_simple_friction_crack_verify';
% Filename='3d_simple_friction_crack_verify';Work_Dirctory='X:\PhiPsi_Work\3d_simple_friction_crack_verify_case1';
% Filename='3d_simple_friction_crack_verify';Work_Dirctory='X:\PhiPsi_Work\3d_simple_friction_crack_verify_case2';
% Filename='3d_simple_friction_crack_verify';Work_Dirctory='X:\PhiPsi_Work\3d_simple_friction_crack_verify_case3';
% Filename='3d_hf_and_a_nf';Work_Dirctory='X:\PhiPsi_Work\3d_hf_and_a_nf';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_fine1';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_fine2';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT4';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT4_fine1';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT8';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT21';

% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT4_fine2';
% Filename='3d_an_hf_and_an_nf';Work_Dirctory='X:\PhiPsi_Work\3d_an_hf_and_an_nf_CT8_fine2';

% Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\PhiPsi_Work\exa_3D_HF_Nonplanar';      % 250x250x250m, l=7.5m, 3.9万单元.
% Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\PhiPsi_Work\exa_3D_HF_Nonplanar_fine';   % 250x250x250m, l=5.5m, 9.7万单元.
% Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\PhiPsi_Work\exa_3D_HF_Nonplanar_fine2';  % 250x250x250m, l=4.5m, 17.6万单元.
% Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\PhiPsi_Work\exa_3D_HF_Nonplanar_fine3';  % 250x250x250m, l=3.5m, 36.4万单元.

Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\Aliyun_downloads\PhiPsi_Work-5800H-2\exa_3D_HF_Nonplanar_fine';   % 250x250x250m, l=5.5m, 9.7万单元.
% Filename='exa_3D_HF_Nonplanar';Work_Dirctory='X:\Aliyun_downloads\PhiPsi_Work-4790k-2\exa_3D_HF_Nonplanar_fine';   % 250x250x250m, l=5.5m, 9.7万单元.

% 其他
% Filename='hydraulic_fracturing_3d';Work_Dirctory='X:\PhiPsi_Project\phipsi_verification\hydraulic_fracturing_3d';

% RESECH_CODE = 2023022301;   %2024-02-23.

Num_Step_to_Plot      = -999       ;       %-999  %后处理结果计算步号
% Num_Step_to_Plot      = 5%-999       ;       %-999  %后处理结果计算步号
% Crack_to_Plot         = 3          ;       %仅绘制给定的裂缝，=0则绘制全部裂缝. 支持3D. 2022-09-28.
...
%                                =3, 绘制增强节点的实际位移矢量;               =4, 绘制增强节点的增强自由度位移矢量；=5,天然裂缝.
%                   13:单元接触状态
%                   14:增强节点(=1,增强节点)
%                   15:Fracture zone
...
%                             =9,绘制扩展步-裂缝体积曲线;
%                             =10,绘制压裂实验仿真时间-压力曲线.
%                   裂缝号(3),4:=1绘制光滑处理前的数据,5:井筒号(=-999,绘制全部),6:时间单位(=1,min;=2,s),Blank(6-15)
...
% Location=  0.12142857E+03;    %Key_PLOT(7,:)绘制Location.
Location=  0.12222222E+03;    %Key_PLOT(7,:)绘制Location.
% Location=  0.12272727E+03;    %Key_PLOT(7,:)绘制Location.
% Location=  0.12272727E+03;    %Key_PLOT(7,:)绘制Location.
...
Key_PLOT(5,:)         = [ 0 ,  2,        0,   1,   0,  Defor_Factor,  0,   0,  0  ,0     ,0     ,0  ,0  ,0  ,       0];   
