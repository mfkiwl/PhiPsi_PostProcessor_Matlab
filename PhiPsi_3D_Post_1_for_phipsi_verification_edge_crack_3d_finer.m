...
%###################################################################################
%----------------------   phipsi_verification  --------------------------
Filename='edge_crack_3d';Work_Dirctory='X:\PhiPsi_Project\phipsi_verification\edge_crack_3d_finer_mesh';
% Filename='edge_crack_3d';Work_Dirctory='X:\PhiPsi_Project\phipsi_verification\edge_crack_3d_2';
...
Key_PLOT(1,:)         = [ 1,   0,        0,   0,   1,  0,             0,   2,  0  ,0     ,0     ,1  ,0  ,1  ,       0];  
Key_PLOT(2,:)         = [ 1,   0,        0,   0,   1,  Defor_Factor,  3,   0,  0  ,1     ,0     ,0  ,0  ,0  ,       0];  
