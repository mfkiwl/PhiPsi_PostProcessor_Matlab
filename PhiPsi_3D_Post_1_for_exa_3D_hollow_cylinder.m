...
Key_PLOT(1,:)         = [ 1,   0,        0,   0,   1,  0,             11,  2,  1  ,0     ,0     ,1  ,0  ,1  ,       0];  
Key_PLOT(2,:)         = [ 1,   0,        0,   0,   1,  Defor_Factor,  0,   0,  0  ,0     ,0     ,0  ,0  ,0  ,       0];  
Key_PLOT(3,:)         = [ 1,   1,        0,   0,   0,  Defor_Factor,  0,   1,  0  ,1     ,0     ,0  ,0  ,0  ,Location];  
Key_PLOT(4,:)         = [ 1,   4,        0,   0,   1,  Defor_Factor,  0,   0,  0  ,1     ,0     ,0  ,0  ,0  ,Location];
