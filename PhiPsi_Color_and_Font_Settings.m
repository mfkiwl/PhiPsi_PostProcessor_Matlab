...
global Title_Font Key_Figure_Control_Widget Key_Axis_NE
...
% Key_Contour_Metd      = 1;                                 % 1: Slow and fine(not available for animation); 2: fast but coarse(default).
...
Key_Posivite_Compressive = 0;                              % if=1 then posivite value indicates compressive stress, for 2D stress contours only.  
...
FaceAlpha_3D_ele_face    = 0.5;                            % 3D单元面的透明度. =0，完全透明；=1，完全不透明. 2023-01-23.