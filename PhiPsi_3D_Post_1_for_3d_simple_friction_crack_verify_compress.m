...
%                                                                                  #
%###################################################################################
Filename='3d_simple_friction_crack_verify';Work_Dirctory='X:\PhiPsi_Work\3d_simple_friction_crack_verify_compress';
...
Key_PLOT(1,:)         = [ 1,   0,        0,   0,   0,  4,             26,  2,  0  ,0     ,0     ,1  ,0  ,1  ,       0];  
Key_PLOT(2,:)         = [ 1,   0,        0,   0,   1,  Defor_Factor,  0,   0,  2  ,2     ,0     ,4  ,0  ,0  ,       0];  
...
% Elements_to_be_Ploted = [1912,2201];
% Elements_to_be_Ploted = [2201];
%###################################################################################
%                                                                                  #
%                                                                                  #
