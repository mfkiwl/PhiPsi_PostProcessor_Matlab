...
Num_Step_to_Plot      = 15             ;%后处理结果计算步号或者破裂步号(对于水力压裂分析),若为-999,则全部绘制
Defor_Factor          = 200                ;%变形放大系数
...
Time_Delay   = 0.2;                 % Delay time of each frame of the gif animation,default: 0.025
...
Key_PLOT(2,:)         = [ 2,  0,  0,  0,  2,  Defor_Factor,  3,  0,  1  ,1  ,1  ,1  ,1  ,0  ,1];  
Key_PLOT(3,:)         = [ 2,  2,  0,  0,  2,  Defor_Factor,  0,  1,  1  ,0  ,0  ,1  ,0  ,0  ,1];  
