...
Time_Delay   = 0.1;                 % Delay time of each frame of the gif animation,default: 0.025
...
Key_PLOT(1,:)         = [ 0,  0,  0,  1,  2,  0,             4,  1,  1  ,1  ,0  ,1  ,1  ,0  ,1];  
Key_PLOT(2,:)         = [ 0,  0,  0,  0,  2,  Defor_Factor,  3,  0,  1  ,1  ,1  ,1  ,1  ,1  ,1];  
Key_PLOT(3,:)         = [ 0,  1,  0,  0,  2,  Defor_Factor,  0,  1,  0  ,0  ,0  ,1  ,0  ,0  ,1];  
