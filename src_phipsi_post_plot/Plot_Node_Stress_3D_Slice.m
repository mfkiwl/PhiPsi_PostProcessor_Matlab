...
if Slice_Type==1   %x轴切片
   ...
   Stress_1 = Stress_Matrix(Ploted_Nodes,2);  %yy应力值
   Stress_2 = Stress_Matrix(Ploted_Nodes,3);  %zz应力值 
   Stress_3 = Stress_Matrix(Ploted_Nodes,7);  %Mises应力值 
elseif Slice_Type==2   %y轴切片
   ...
   Stress_1 = Stress_Matrix(Ploted_Nodes,1);  %xx应力值
   Stress_2 = Stress_Matrix(Ploted_Nodes,3);  %zz应力值
   Stress_3 = Stress_Matrix(Ploted_Nodes,7);  %Mises应力值
elseif Slice_Type==3   %z轴切片
   ...
   % Stress_3 = Stress_Matrix(Ploted_Nodes,8);  %Mises应力值
   Stress_1 = Stress_Matrix(Ploted_Nodes,1);  %xx应力值
   Stress_2 = Stress_Matrix(Ploted_Nodes,2);  %yy应力值
   Stress_3 = Stress_Matrix(Ploted_Nodes,7);  %Mises应力值
end
% Plot the contours.
for i_Plot = 1:3   
